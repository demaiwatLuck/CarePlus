...
public class LabTestActivity extends AppCompatActivity {
    ...
    private String[] package_details = {
            "Blood Glucose Fasting\n" +
                    ...
                    "Liver Function\n" +
                    "Blood Glucose Fasting",
            "COVID-19 Antibody - IgG. When fasting blood glucose is between 100 to 125 mg/dL (5.6 to 6.9 mmol/L) changes in lifestyle and monitoring glycemia are recommended.",
